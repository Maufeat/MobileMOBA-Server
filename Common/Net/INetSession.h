...
#include <map>
using namespace std;
#include "net\ucnetopt.h"
#include "net\ucnet.h"
using namespace UCODE;
#ifdef _DEBUG
#pragma comment(lib,"../Thirdparty/ucore/bin/x64/Debug/ucodebase.lib")
#pragma comment(lib,"../Thirdparty/ucore/bin/x64/Debug/ucodenet.lib")
#else
#pragma comment(lib,"../Thirdparty/ucore/bin/x64/Release/ucodebase.lib")
#pragma comment(lib,"../Thirdparty/ucore/bin/x64/Release/ucodenet.lib")
#endif
