...
public:
	...
	static bool Msg_AskRegister(const char* pMsg, int n32MsgLength, INetSession* vthis, int n32MsgID);
	static bool Msg_Handle_ReportGsInfo(const char* pMsg, int n32MsgLength, INetSession* vthis, int n32MsgID);
	static bool Msg_Handle_Dispath(const char* pMsg, int n32MsgLength, INetSession* vthis, int n32MsgID);
	static bool Msg_Handle_OneUserLoginTokenRet(const char* pMsg, int n32MsgLength, INetSession* vthis , int n32MsgID);
};
